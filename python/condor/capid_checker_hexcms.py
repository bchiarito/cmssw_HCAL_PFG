...
parser.add_option('--run', type=int, action='store', dest='run', help='for running with conodr')
(options, args) = parser.parse_args()

input_files = ""
if not options.queue == None:
  print('Got a queue number:', options.queue, ", and a run number: ", options.run)
  if options.run == 316110:
    input_files = "/cms/chiarito/eos/hcal/task9/run316110_filebased/ZeroBias/hcaltuple_run316110/180719_085550/0000/"
    input_files += "hcalTupleTree_"+str(options.queue+1)+".root"
    print("Using the file: ", input_files)
  if options.run == 316972:
    input_files = "/cms/chiarito/eos/hcal/task9/multirun_allbad/ZeroBias/hcaltuple_run316972/180720_133252/0000/"
    input_files += "hcalTupleTree_"+str(options.queue+1)+".root"
    print("Using the file: ", input_files)
  if options.run == 317738:
    input_files = "/cms/chiarito/eos/hcal/task9/multirun_allbad/ZeroBias/hcaltuple_run317738/180720_133306/0000/"
    input_files += "hcalTupleTree_"+str(options.queue+1)+".root"
    print("Using the file: ", input_files)
  if options.run == 318983:
    input_files = "/cms/chiarito/eos/hcal/task9/multirun_allbad/ZeroBias/hcaltuple_run318983/180720_133321/0000/"
    input_files += "hcalTupleTree_"+str(options.queue+1)+".root"
    print("Using the file: ", input_files)
  if options.run == 319629:
    input_files = "/cms/chiarito/eos/hcal/task9/multirun_allbad/ZeroBias/hcaltuple_run319629/180720_133337/0000/"
    input_files += "hcalTupleTree_"+str(options.queue+1)+".root"
    print("Using the file: ", input_files) 
else:
  input_files = args[0]
