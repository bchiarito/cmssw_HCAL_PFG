...
options.register('outputFile',
                 "HcalTupleMaker_new2.root", # default value
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 "Output file")
...
#process.hcalTupleQIE11Digis.chargeSkim = cms.untracked.double(5000) ###NEW comment this out
#------------------------------------------------------------------------------------
# Specify Global Tag
#------------------------------------------------------------------------------------
...
process.tuple_step = cms.Sequence(
    ...
    process.hcalTupleFEDs* ###NEW uncomment

    ## Make HCAL tuples: digi info
    process.hcalTupleHBHEDigis* ###NEW uncomment
    process.hcalTupleHODigis* ###NEW uncomment
    #process.hcalTupleHFDigis*
    process.hcalTupleQIE10Digis* # for HF ###NEW uncomment
...
process.preparation = cms.Path(
    ...
    #process.RawToDigi*
    process.hcalDigis* ###NEW uncomment
    process.qie10Digis* ###NEW uncomment
    process.qie11Digis* ###NEW uncomment
