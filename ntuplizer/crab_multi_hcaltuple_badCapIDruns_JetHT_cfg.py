...
config.Data.outLFNDirBase = '/store/user/bchiari1/noreplica/hcal/task9/multirun_allbadcapid_JetHT/'
...
if __name__ == '__main__':
    ...
    config.Data.inputDataset = '/JetHT/Run2018A-v1/RAW'
    ...
    config.Data.inputDataset = '/JetHT/Run2018C-v1/RAW'
